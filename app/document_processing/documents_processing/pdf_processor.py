...
class MarkerProcessor:
    ...
    def _initialize(self):
        ...
        try:
            ...
            config_parser = ConfigParser(marker_config) # type: ignore
            
            self.converter = PdfConverter( # type: ignore
    ...
    def _process_single_file(self, file_path: Union[str, Path]) -> Dict[str, Any]:
        ...
        try:
            rendered = self.converter(str(file_path)) # type: ignore
...
class DoclingProcessor:
    ...
    def _initialize(self):
        ...
        try:
            ...
            self.converter = DocumentConverter( # type: ignore
                format_options={
                    InputFormat.PDF: { # type: ignore
